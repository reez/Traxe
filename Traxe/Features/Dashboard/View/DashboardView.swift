    ...
    private var topMetricsGrid: some View {
        LazyVGrid(
            ...
            MetricCard(
                ...
                icon: "bolt.fill",
                expectedValue: viewModel.connectionState == .connected
                    && viewModel.currentMetrics.expectedHashrate > 0
                    ? viewModel.formattedExpectedHashRate : nil,
                expectedUnit: viewModel.connectionState == .connected
                    && viewModel.currentMetrics.expectedHashrate > 0
                    ? viewModel.formattedExpectedHashRateUnit : nil,
